...
public class AdmissionsResource {
	...
	List<Patient> patients = Arrays.asList(new Patient("P1", "Joseph", "Brazil"),
			new Patient("P2", "William", "American"), new Patient("P3", "Sanjith", "Indian"));
	...
	public Employee getPhysicians() {
		Employee physicians =
				// restTemplate.getForObject("http://localhost:8082/hr/employees",
				// EmployeesList.class);
				restTemplate.getForObject("http://hr-service/hr/employees", Employee.class);
		return physicians;
	}
